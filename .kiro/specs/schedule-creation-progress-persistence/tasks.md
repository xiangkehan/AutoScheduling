...
- [ ] 1. Create draft data transfer objects
...
- [ ] 2. Implement draft service interface and implementation
  - [ ] 2.1 Create `ISchedulingDraftService` interface
  ...
  - [ ] 2.2 Implement `SchedulingDraftService` class
...
- [ ] 3. Add draft management to SchedulingViewModel
  ...
  - [ ] 3.1 Create `SchedulingViewModel.Draft.cs` partial class
  ...
  - [ ] 3.2 Implement draft restoration helper methods
  ...
  - [ ] 3.3 Add draft validation logic
...
- [ ] 4. Integrate draft persistence into CreateSchedulingPage

  - [ ] 4.1 Modify `OnNavigatedTo` lifecycle method
  ...
  - [ ] 4.2 Modify `OnNavigatedFrom` lifecycle method
  ...
  - [ ] 4.3 Implement `ShouldSaveDraft()` helper method
...
- [ ] 5. Add draft cleanup on successful schedule creation



  - [ ] 5.1 Modify `ExecuteSchedulingAsync` in SchedulingViewModel
...
- [ ] 6. Add draft handling to cancel operation
  ...
  - [ ] 6.1 Modify `CancelWizard` method in SchedulingViewModel
    ...
    - Show ContentDialog asking user to keep or discard draft
