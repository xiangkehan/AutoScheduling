...
- [x] 14.5 添加加载指示器（P1 剩余项）
  - 在左侧冲突列表添加 ProgressRing ✅
  - 在主内容区添加加载遮罩 ✅
  - 在右侧详情区添加加载状态 ✅
...
- **P0阶段**：9个主任务，约60个子任务，预估19天 ✅ **已完成 100%**
- **P1阶段**：5个主任务，约31个子任务，预估16天 ✅ **已完成 100%**（仅剩测试验证）
- **P2阶段**：5个主任务，约25个子任务，预估10天 ✅ **已完成 100%**（仅剩测试验证）
- **P3阶段**：6个主任务，约30个子任务，预估9天 ⏳ **待开始**
