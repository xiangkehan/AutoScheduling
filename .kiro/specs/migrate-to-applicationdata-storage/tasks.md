...
- [-] 1. 更新 DatabaseConfiguration 类使用 ApplicationData API
...
- [ ] 2. 更新 ConfigurationService 类使用 ApplicationData API
...
- [ ] 3. 更新 StoragePathService 类使用 ApplicationData API
