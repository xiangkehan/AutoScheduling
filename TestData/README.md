...
应用内置了完整的测试数据生成器 UI，位于"设置" → "测试数据生成器"。

**功能特性：**
- 5种预设配置场景（小规模、中等规模、大规模、演练场景、实战场景）
- 完整的自定义配置选项（12个可配置参数）
- 实时参数验证和提示
- 生成进度显示
- 最近生成文件列表
...
**使用步骤：**
1. 打开应用，进入"设置" → "测试数据生成器"
2. 选择预设场景或选择"自定义"进行精确配置
3. 点击"生成测试数据"按钮
4. 等待生成完成，查看统计信息
5. 可选：直接导入生成的数据或打开文件位置
...
详细的 UI 使用说明请参考 [UI-UPDATE.md](./UI-UPDATE.md)。
